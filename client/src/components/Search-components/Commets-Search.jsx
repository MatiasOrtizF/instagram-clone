...
import dataSearch from '../../data/search-data.json'

export default function Comments({route}) {
    Comments.navigationOptions = {
        tabBarVisible:false
    }
    const { hDataPost , addComment , likedComment , addReply } = useDatas();
    ...
    return (
        <View style={{paddingVertical:5 , flex:1}}>
            ...
            {dataSearch.post[postNumber].comments.map((comment, index) => 
